// Version 1.3.11 ip.js - https://github.com/vasturiano/ip.js
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
  typeof define === 'function' && define.amd ? define(['exports'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Ip = {}));
  ...
  var Addr = /*#__PURE__*/function () {
    ...
    return _createClass(Addr, [{
      ...
      function toBin() {
        var bin = this.op.toString(this.num, 2);

        // Pad with 0s
        while (bin.length < (this.isV4 ? 32 : 128)) bin = "0".concat(bin);
        return bin;
      }
    }, {
      key: "compare2Ip",
  ...
  var Prefix = /*#__PURE__*/function () {
    ...
    return _createClass(Prefix, [{
      ...
      function correctBitBoundary() {
        var op = this.op;
        var nBits = this.isIPv4() ? 32 : 128;
        var mask = op.sub(op.exp(op.num(2), op.num(nBits - this.cidr)), op.num(1));
        var correctedNum = fixSign(op.bitAnd(this.ip.toNum(), op.bitNeg(mask)));
        ...
        function fixSign(n) {
          ...
          return op.lt(n, op.num(0)) ? op.add(n, op.exp(op.num(2), op.num(nBits))) : n;
        }
      }
      ...
      value: function slice(cidr) {
        ...
        for (var i = 0, len = Math.pow(2, cidr - this.cidr); i < len; i++) {
          var _slice = new Prefix(runningIp, cidr, this.isIPv4());
          slices.push(_slice);
          runningIp = _slice.lastIp().addIp(oneIP);
        }
        return slices;
      }
    }]);
    ...
    return _createClass(Range, [{
      ...
      value: function toPrefixes() {
        ...
        while (sweepIp.compare2Ip(endIp) <= 0) {
          ...
          if (sweepIp.compare2Ip(zeroIP) === 0 || sweepIp.version() > endIp.version())
            // Counter flipped back to start
            break;
        }
        return prefixes;
      }
